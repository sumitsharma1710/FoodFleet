...
} = require("./authRepository"); // Import user-related repository functions
  ...
  try {
    ...
    if (!userDetails) {
      throw new CustomError(
        "User doesn't exist with this email, Please sign up!",
        404
      ); // User not found
    }
